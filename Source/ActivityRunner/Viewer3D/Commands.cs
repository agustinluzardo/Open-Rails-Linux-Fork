...
namespace Orts.ActivityRunner.Viewer3D
{
    ...
    public sealed class CameraChange3DCabViewPointCommand : UseCameraCommand
    {
        ...
        public override void Redo()
        {
            if (Receiver.Camera?.AttachedCar?.CabViewpoints == null || Receiver.Camera.AttachedCar.CabViewpoints.Count == 0)
                return;
            ...
            if (Receiver.Camera.AttachedCar.CabViewpoints.Count == 1)
                ...
                Receiver.ThreeDimCabCamera.Change3DCabViewPoint(Receiver.Camera.AttachedCar);
        }
    }
