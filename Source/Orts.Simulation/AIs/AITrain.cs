...
namespace Orts.Simulation.AIs
{
    public class AITrain : Train
    {
        ...
        public override async ValueTask Restore([NotNull] TrainSaveState saveState)
        {
            ...
            if (aiTrainSaveState.TrafficItemSaveStates != null)
            {
                ServiceDefinition = new Services();
                await ServiceDefinition.RestoreCollectionCreateNewItems(aiTrainSaveState.TrafficItemSaveStates).ConfigureAwait(false);
            }
        ...
        public virtual bool CheckInitialStation()
        {
            ...
            bool atStation = CheckStationPosition(thisStation.PlatformItem, thisStation.Direction, thisStation.TrackCircuitSectionIndex);
