...
namespace FreeTrainSimulator.Common.Input
{
    ...
    public enum UserCommand
    {
        ...
        [Description("Display HUD Scroll Left")] DisplayHUDScrollLeft,
        [Description("Display HUD Scroll Right")] DisplayHUDScrollRight,
        [Description("Display HUD Scroll Up")] DisplayHUDScrollUp,
        [Description("Display HUD Scroll Down")] DisplayHUDScrollDown,
        [Description("Display HUD Next Loco")] DisplayHUDPageUp,
        [Description("Display HUD Previous Loco")] DisplayHUDPageDown,
        ...
        [Description("Debug Toggle Confirmations")] DebugToggleConfirmations,

        [Description("Camera Cab")] CameraCab,
        [Description("Camera Change Passenger Viewpoint")] CameraChangePassengerViewPoint,
        [Description("Camera Toggle 3D Cab")] CameraToggleThreeDimensionalCab,
        ...
        [Description("Control Large Ejector Increase")] ControlLargeEjectorIncrease,
        ...
        // Cruise Control
        [Description("Control Speed Regulator Mode Increase")] ControlSpeedRegulatorModeIncrease,
        [Description("Control Speed Regulator Mode Descrease")] ControlSpeedRegulatorModeDecrease,
        [Description("Control Selected Speed Increase")] ControlSpeedRegulatorSelectedSpeedIncrease,
        [Description("Control Selected Speed Decrease")] ControlSpeedRegulatorSelectedSpeedDecrease,
        [Description("Control Speed Regulator Max Acceleration Increase")] ControlSpeedRegulatorMaxAccelerationIncrease,
        [Description("Control Speed Regulator Max Acceleration Decrease")] ControlSpeedRegulatorMaxAccelerationDecrease,
        [Description("Control Number Of Axles Increase")] ControlNumberOfAxlesIncrease,
        [Description("Control Number Of Axles Decrease")] ControlNumberOfAxlesDecrease,
        [Description("Control Restricted Speed Zone Active")] ControlRestrictedSpeedZoneActive,
        [Description("Control Cruise Control Mode Increase")] ControlCruiseControlModeIncrease,
        [Description("Control Cruise Control Mode Decrease")] ControlCruiseControlModeDecrease,
        [Description("Control Train Type Change (Passenger/Cargo)")] ControlTrainTypePaxCargo,
        [Description("Control Selected Speed To Zero")] ControlSpeedRegulatorSelectedSpeedToZero,
        //Distributed power
